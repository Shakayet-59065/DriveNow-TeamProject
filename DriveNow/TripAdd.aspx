<%-- DriveNow — Add Trip Page (TripAdd.aspx)
     Staff use this form to manually create a new trip booking.
     Dropdowns for Customer, Vehicle, Trip Type, and Driver are all loaded from the database.
    ...
    <div class="dn-main">
        <div class="dn-topbar">
            ...
            <div class="dn-topbar-left">
                <span class="dn-page-title">Add Trip</span>
                <span class="dn-page-sub">Book a trip on behalf of a customer</span>
            </div>
        ...
        <div class="dn-content">
            <div class="dn-form-card">
                ...
                <!-- CUSTOMER & VEHICLE -->
                <div class="form-section-head">Booking Details</div>
                <div class="form-row">
                    <div class="dn-field">
                        ...
                        <div class="dn-hint">Select the customer this trip is booked for.</div>
                    </div>
                    <div class="dn-field">
                ...
                <div class="dn-field">
                    ...
                    <div class="dn-hint">Select the vehicle assigned to this trip.</div>
                </div>

                <!-- LOCATIONS -->
                <div class="form-section-head">Locations</div>
                <div class="form-row">
                    <div class="dn-field">
                        ...
                        <asp:TextBox ID="txtPickupLocation" runat="server" CssClass="dn-input"
                            placeholder="e.g. 25 King Street, London" MaxLength="200" />
                    </div>
                    <div class="dn-field">
                        ...
                        <asp:TextBox ID="txtDropoffLocation" runat="server" CssClass="dn-input"
                            placeholder="e.g. Heathrow Airport, Terminal 2" MaxLength="200" />
                    </div>
                </div>

                <!-- DATES & TIMES -->
                <div class="form-section-head">Schedule</div>
                <div class="form-row">
                    <div class="dn-field">
                ...
                <div class="form-row">
                    <div class="dn-field">
                        ...
                        <asp:RequiredFieldValidator ID="rfvDropoffDate" runat="server"
                            ControlToValidate="txtDropoffDate"
                ...
                <!-- DRIVER -->
                <div class="form-section-head">Driver Assignment</div>
                <div class="dn-field">
                    <label class="dn-label">Assign Driver <span style="font-weight:400;color:#64748b;">(optional)</span></label>
                    <asp:DropDownList ID="ddlDriver" runat="server" CssClass="dn-select" />
                    <div class="dn-hint">Select an available driver, or leave as Self-Drive for an unassigned rental.</div>
                </div>

                <!-- NOTES -->
                <div class="dn-field" style="margin-top:.5rem;">
                    <label class="dn-label">Notes <span style="font-weight:400;color:#64748b;">(optional)</span></label>
                ...
                <!-- INSURANCE -->
                <div class="form-section-head">Insurance</div>
                <asp:HiddenField ID="hdnInsurance" runat="server" Value="Basic" />
                <div class="ins-grid">
                    <div class="ins-card ins-selected" id="ins-Basic" onclick="selectIns('Basic')">
                ...
                <!-- ADD-ONS -->
                <div class="form-section-head">Add-Ons &amp; Extras</div>
                ...
                <div class="dn-form-actions">
                    <asp:Button ID="btnSave" runat="server" Text="Book Trip"
