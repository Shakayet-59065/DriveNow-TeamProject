<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerFind.aspx.cs" Inherits="DriveNow.CustomerFind" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Find Customer — DriveNow Admin</title>
    ...
    <div class="dn-main">
        <div class="dn-topbar">
            ...
            <div class="dn-topbar-left">
                <span class="dn-page-title">Find Customer</span>
                <span class="dn-page-sub">Search by ID or name</span>
            </div>
        ...
        <div class="dn-content">
            ...
            <div class="dn-form-card">
                <div class="dn-field">
                    <label class="dn-label">Customer ID</label>
                    <asp:TextBox ID="txtCustomerID" runat="server" CssClass="dn-input" placeholder="e.g. 3" />
                </div>
                <div class="dn-field">
                    <label class="dn-label">Full Name (partial match)</label>
                    <asp:TextBox ID="txtFullName" runat="server" CssClass="dn-input" placeholder="e.g. Alice" />
                </div>
                <div class="dn-form-actions">
                    <asp:Button ID="btnFind"  runat="server" Text="Search"     CssClass="dn-btn dn-btn-primary"   OnClick="btnFind_Click" CausesValidation="false" />
                    <asp:Button ID="btnClear" runat="server" Text="Clear"      CssClass="dn-btn dn-btn-secondary" OnClick="btnClear_Click" CausesValidation="false" />
